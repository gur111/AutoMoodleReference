...
function answerAllQuestions() {
    ...
    for (var i = 0; i <= 9; i++) {
        try{
            ...
            console.log('Error in question number ' + i);
            console.log("Error: " + e);
        }
    }
}
